...
function [iS] = getForces3(stks1,eps_reg)
    ...
    for ii = 1:ntot
        for jj = 1:ntot
            ...
            r1 = stks1(ii,1:2); % Position of point force ii
            r2 = stks1(jj,1:2); % Position of point force jj

            dx = r1(1)-r2(1); % x-distance
            dy = r1(2)-r2(2); % y-distance

            r = norm(r1-r2); % Ordinary distance
            R = sqrt(r^2 + eps_reg^2) + eps_reg; % Regularized distance
